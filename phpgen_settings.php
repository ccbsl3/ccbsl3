...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => 'Ministério', 'short_caption' => 'Ministério', 'filename' => 'cadministerio.php', 'name' => 'cadministerio', 'group_name' => 'Congregação', 'add_separator' => false, 'description' => '');
