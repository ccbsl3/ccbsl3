 ...
 */
    ...
    class GRUPO_VOLUNTARIOPage extends Page
    {
    ...
    try
    {
        $Page = new GRUPO_VOLUNTARIOPage("GRUPO_VOLUNTARIO", "GRUPO_VOLUNTARIO.php", GetCurrentUserPermissionSetForDataSource("GRUPO_VOLUNTARIO"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("GRUPO_VOLUNTARIO"));
